    ...
    <div className="pb-16">
      <div className="container mx-auto px-4 mt-6">
        <div className="rounded-2xl bg-gradient-to-r from-purple-600/30 to-fuchsia-600/20 p-6 ring-1 ring-purple-500/20">
          ...
          <p className="text-neutral-300 mt-1">Trending, popular, and top-rated. Search anything from the navbar.</p>
        </div>
      </div>
      ...
      <Section
        ...
        onNext={()=> trending.setPage(Math.min(trending.data.total_pages, trending.page+1))}
      ...
      <Section
        ...
        onNext={()=> popular.setPage(Math.min(popular.data.total_pages, popular.page+1))}
